...
object AppPreferences {
    private const val NAME = "hw4_translator"
    ...
    private val HEAD_IMAGE=Pair("head_image", "")
    ...
    var headImages: String
        get() = preferences.getString(HEAD_IMAGE.first, HEAD_IMAGE.second) ?: ""
        set(value) = preferences.edit {
            it.putString(PASSWORD.first, value)
        }
}